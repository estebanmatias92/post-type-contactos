...
if ( !class_exists( 'Contactos_Get_Templates' ) ) :

    /**
     * Contactos_Get_Templates
     *
     ...
     */
    class Contactos_Get_Templates extends Post_Type_Contactos
    {
        ...
        private function get_template_hierarchy( $template )
        {
            ...
            if ( $theme_file = locate_template( array( $template_post_type ) ) ) {
                ...
                $file = PTC_PLUGIN_ROOT . 'views/templates/' . $template;
            }
